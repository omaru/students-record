...
class StudentControllerIT {
	...
	void testSaveStudent() throws Exception {
		...
		final String request = objectMapper.writeValueAsString(student);
		mockMvc.perform(post(ControllerConstants.STUDENT_URI).content(request).contentType(MediaType.APPLICATION_JSON))
	...
	void testCompareStudents() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(get(ControllerConstants.STUDENT_URI + ControllerConstants.STUDENT_COMPARE)
						.param(ControllerConstants.STUDENT_ID_1, "1").param(ControllerConstants.STUDENT_ID_2, "2"))
