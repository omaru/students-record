...
public class WireMockHelper {
	...
	public WireMockHelper stubsForPostionFromStudent() {
		wireMockServer.stubFor(get(urlPathEqualTo(
				"/forward?access_key=ea4f12d05df8c061aa8dc52612325ab2&query=1600%20Pennsylvania%20Ave%20NW,%20Washington%20DC,%20Washington%20DC%2077057%20USA"))
						.willReturn(aResponse().withStatus(OK.value()).withHeader(CONTENT_TYPE, APPLICATION_JSON_VALUE)
								.withBody("{\n" + "    \"data\": [\n" + "        {\n"
										+ "            \"latitude\": 38.897675,\n"
										+ "            \"longitude\": -77.036547,\n"
										+ "            \"type\": \"address\",\n"
